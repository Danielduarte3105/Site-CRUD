        ...
        <div class="content-lg container">
            <div class="row">
                ...
                <div class="col-sm-5 sm-margin-b-30">
                    <h2 class="color-white" data-pt="Mande-nos uma mensagem!" data-en="Send us a message!"></h2>
                    <br>
                    <p data-pt="Explicando como ocorreu o erro!" data-en="Explaining how the error occurred!"></p>
                    <form
                        id="contact-form"
                        name="cform"
                        method="post"
                    ...
                    >
                        ...
                        <input type="text" id="fn" name="uname" class="form-control footer-input margin-b-20" placeholder="Nome" required>


                        <textarea name="msg" id="fm" class="form-control footer-input margin-b-30" rows="6" placeholder="Mensagem" required></textarea>
